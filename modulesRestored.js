...
var budgetController = (function() {
    ...
    return {
        ...
        //vreau sa imi stearga toate input-urile din incomes si expenses
        //pt asta avem nevoie de lungimea arrayului ca sa stim sa 
        //stergem de la 0 pana la ultimul element din array

        deleteAll: function(type) {
        	
        	var lastIndex = data.allItems[type].length;
        	data.allItems[type].splice(0, lastIndex);        	        		
        },
...
var UIController = (function() {
	...
	return {
		...
		rotateBtn: function(type) {
			if (type === 'inc') {
				document.getElementById('btnInc').classList.add('rotate');
				window.setTimeout(function() {
					document.getElementById('btnInc').classList.remove('rotate')
		        }, 500);

        	} else if (type === 'exp') {
        		document.getElementById('btnExp').classList.add('rotate');
        		window.setTimeout(function() {
        			document.getElementById('btnExp').classList.remove('rotate');
        	    }, 500);
            }
        },
...
var controller = (function(budgetCtrl, UICtrl) {
	...
	var setupEventListeners = function() {
        ...
        document.querySelector(DOM.deleteLabel).addEventListener('click', deleteAllContent);
        document.querySelector(DOM.resetIncomeLabel).addEventListener('click', function() {
        	budgetCtrl.resetAll('inc');
        	UICtrl.rotateBtn('inc');
    	    UICtrl.deleteItemUI('inc');
    	    updateBudget();
    	    updatePercentages();

        });
        document.querySelector(DOM.resetExpensesLabel).addEventListener('click', function() {
    	    budgetCtrl.resetAll('exp');
    	    UICtrl.rotateBtn('exp');
    	    UICtrl.deleteItemUI('exp');
    	    updateBudget();
    	    updatePercentages();
